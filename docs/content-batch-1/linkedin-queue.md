Platform: LinkedIn (9 posts, 3 per spiking theme; audience = agronomists / farm advisors / ag-lenders, NOT farmers)
Sources: /articles/cover-crops-roi, /articles/regenerative-agriculture-economics, /articles/pros-and-cons-of-advanced-biofuels · Goal: advisor-layer reach, referrals via profile (no links in body).

---

## Theme A — Cover crops ROI

### Post A1 — the year-one conversation
...
Advisors: how do you set the year-one expectation in practice — do you show clients a multi-year cash flow up front, or manage it season by season?

#coverCrops #farmEconomics
...
Yet the marketing typically leads with the least defensible line and buries the most defensible one.

Ag-lenders and advisors who review transition budgets: which soil-health benefit lines do you actually accept in a cash-flow projection, and which get struck out?

#agLending #coverCrops
...
#agLending #regenerativeAgriculture
...
## Theme C — Advanced biofuels pros/cons

### Post C1 — the farm question isn't "are biofuels good"

Most advanced-biofuels debate happens at the policy level: 80% emissions cuts vs. high production costs, drop-in fuels vs. electrification. Interesting — and mostly useless to an individual operation.
...
#biofuels #circularEconomy

### Post C2 — where biofuels win by default

Reading the advanced-biofuels evidence base, the honest summary is: strong where electrification can't reach, weak where it can.

Aviation and shipping can't run on batteries at scale yet — drop-in biofuels are one of few near-term options there, which is why that demand looks durable. Road transport is the opposite: biofuels compete head-on with electrification and cheap fossil fuel, in a policy environment that shifts with every election.

For agriculture, that split matters. Feedstock demand anchored to aviation mandates is a different bet than demand anchored to road-fuel subsidies that may not survive the next government.

Advisors and lenders: are you seeing clients approached with feedstock supply contracts yet — and how are you assessing counterparty risk on offtakers in a policy-dependent market?

#biofuels #agFinance

### Post C3 — the residue trade-off nobody prices

Selling crop residues to a biofuel producer looks like free money: the crop's harvested, the straw's just sitting there.
