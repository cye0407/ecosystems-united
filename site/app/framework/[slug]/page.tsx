...
const stacks = {
  "stack-1-metrics": {
    ...
    outcome: "Know your baseline + understand the external landscape you're operating in",
    ...
    keyCapability: "Internal data + external context = informed decision-making",
    themes: [
  ...
  "stack-2-efficiency": {
    ...
    keyCapability: "Data becomes actionable intelligence revealing improvement opportunities",
    themes: [
  ...
  "stack-3-circularity": {
    ...
    keyCapability: "Moving from insight to implementation — restructuring operations based on what you learned",
    themes: [
    ...
    requirement: "Stack 2 insights — you need to know what patterns exist before you can transform them",
  ...
  "stack-4-resilience": {
    ...
    outcome: "Layer multiple value streams so you're not dependent on single crops/products/markets",
    ...
    keyCapability: "Strategic diversification creating operational resilience against shocks",
    themes: [
    ...
    requirement: "Stack 3 implementations — you're layering additional value streams on top of transformed operations",
  ...
  "stack-5-regenerative": {
    ...
    outcome: "Organizational capability to steer dynamically across your value portfolio",
    ...
    keyCapability: "Strategic agility — sensing changes and steering operations responsively",
    themes: [
    ...
    requirement: "Stacks 2-4 — you need insights, implementations, and diversification before you can navigate strategically",
    nextStack: null,
...
export function generateMetadata({ params }: { params: { slug: string } }) {
  const stack = stacks[params.slug as keyof typeof stacks];
...
export default function StackPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-16">
      {/* Breadcrumb */}
      <div className="mb-8">
        <Link href="/framework" className="text-[#4AA88C] hover:underline text-sm">
          ← Back to Framework
        </Link>
      </div>
      ...
      <div className="max-w-3xl mb-12">
        <div className="text-[#5B5FC7] font-semibold mb-2">Stack {stack.num}</div>
      ...
      <div className="max-w-3xl space-y-12">
        ...
        {/* Key Capability */}
        <div className="border-l-4 border-[#4AA88C] pl-4">
          <h2 className="text-lg font-semibold text-gray-900 mb-2">Key capability</h2>
          <p className="text-gray-700">{stack.keyCapability}</p>
        </div>

        {/* Content Themes */}
        <div>
          <h2 className="text-lg font-semibold text-gray-900 mb-3">Content themes</h2>
        ...
        {/* Requirement */}
        <div>
          <h2 className="text-lg font-semibold text-gray-900 mb-3">Implementation requirement</h2>
        ...
        <div className="flex justify-between pt-8 border-t border-gray-200">
          {stack.prevStack ? (
            <Link 
              ...
              className="text-[#4AA88C] hover:underline"
            >
              ← Previous Stack
            </Link>
          ) : <div />}
