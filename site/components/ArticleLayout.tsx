...
export default function ArticleLayout({ title, stack, children, nextSteps }: ArticleLayoutProps) {
  ...
  return (
    <article className="max-w-6xl mx-auto px-6 py-16">
      ...
      <div className="mb-8">
        <Link 
          href={stack !== "general" ? `/framework/${stack}-${stackData.name.toLowerCase().replace(' ', '-')}` : "/framework"}
      ...
      {/* So What / Next Steps */}
      {nextSteps && (
        <div className="border-l-4 pl-6 py-4 mb-12" style={{ borderColor: stackData.color }}>
          <h2 className="text-lg font-semibold text-gray-900 mb-2">So what does this mean for you?</h2>
      ...
      <div className="border-t border-gray-200 pt-8">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Continue with {stackData.name}</h3>
