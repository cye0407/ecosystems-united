    ...
    <nav className="border-b border-gray-200">
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        <Link href="/" className="flex items-center">
          <Image src="/logo.png" alt="Ecosystems United" width={150} height={50} />
        </Link>
        <div className="flex gap-6 text-sm">
          <Link href="/modern-sustainability" className="text-gray-600 hover:text-[#4AA88C]">
          ...
          >
            <Link 
              href="/framework" 
              className="text-gray-600 hover:text-[#4AA88C] flex items-center gap-1"
            >
              The Five Stacks
                ...
                <div className="bg-white border border-gray-200 rounded-lg shadow-lg py-2 min-w-[200px]">
                  ...
                  <div className="border-t border-gray-100 mt-2 pt-2">
                    <Link
                      ...
                      className="flex items-center gap-3 px-4 py-2 hover:bg-gray-50 transition-colors"
                    >
                      <div className="w-6 h-6 rounded-full flex items-center justify-center bg-[#4AA88C] text-white text-xs font-bold">
                        →
                      </div>
          ...
          <Link href="/tools" className="text-gray-600 hover:text-[#4AA88C]">
            Tools
          </Link>
          <Link href="/about" className="text-gray-600 hover:text-[#4AA88C]">
            About
          </Link>
        </div>
      </div>
