    ...
    <div className="bg-gray-50 rounded-lg p-8 text-center">
      ...
      >
        <input 
          ...
          required
          className="flex-1 px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-[#4AA88C]"
        />
        <button 
          type="submit"
          className="bg-[#4AA88C] text-white px-6 py-2 rounded font-medium hover:bg-[#3d8f77]"
        >
          Subscribe
        </button>
      </form>
