...
import type { GAPFarmData } from './dataModel';

// ============================================
// Framework Notes
// ============================================

const GAP_FRAMEWORK_NOTES: Record<string, string> = {
...
export const gapDomainPack: DomainPack<GAPFarmData> = {
  name: 'globalg-a-p',
  version: '1.0.0',
...
export type { GAPFarmData } from './dataModel';
