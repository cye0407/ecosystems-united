// ============================================
// ResponseReady — Core Engine Types (Domain-Agnostic)
// ============================================
// These types describe the generic pipeline. No domain-specific
// knowledge (ESG, security, RFP, etc.) belongs here.
...
export type DataSource = string; // Domain packs define their own source types
...
export interface KeywordRule {
  keywords: string[];
  domain: string;    // Generic string — ESG pack uses 'emissions', 'workforce', etc.
  topics: string[];  // Generic string — ESG pack uses 'ghg_emissions', 'scope_1', etc.
  weight: number;
}
...
export interface ClassificationResult {
  questionId: string;
  questionType: string;   // ESG uses 'POLICY' | 'MEASURE' | 'KPI', other packs define their own
...
export interface SignalRule {
  type: string;           // The question type this signal indicates
  patterns: RegExp[];
  keywords: string[];
  weight: number;
}
...
// ============================================
// Configuration (loaded from CSV/JSON)
// ============================================
