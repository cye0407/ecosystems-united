 ...
 */
export function createRewriter(scrubRules: ScrubRule[]): RewriterInstance {

  function rewriteAnswer(text: string): string {
    let result = text;
  ...
  function rewriteAnswerBatch(answers: string[]): string[] {
