...
export interface Issue {
    code: 'missing_expected_field' | 'multiple_candidate_values' | 'ambiguous_unit' | 'period_not_found' | 'document_type_uncertain' | 'low_confidence_field';
    field?: string;
    message: string;
}
...
export type DocumentType = 'electricity_bill' | 'gas_invoice' | 'water_bill' | 'waste_manifest' | 'payroll_summary' | 'unknown';
