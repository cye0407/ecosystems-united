    ...
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <header className="mb-12">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-8 h-8 rounded-full bg-[#B8ADE3] text-white flex items-center justify-center font-bold">
            5
          </div>
        ...
        <p className="text-xl text-gray-600">
          How to increase soil organic matter through cover crops, compost, reduced tillage, and residue management—and the economic payoff that follows.
        </p>
      </header>
      ...
      <article className="prose prose-gray max-w-none">
        ...
        <h2>What Soil Organic Matter Does</h2>

        <p>
          Soil organic matter is far more than just &ldquo;dead stuff&rdquo; in the ground. It&apos;s a dynamic component of soil health that delivers multiple benefits:
        </p>

        <ul>
          <li><strong>Water retention:</strong> SOM acts like a sponge, holding up to 20 times its weight in water. In drought conditions, this can be the difference between crop failure and a viable harvest.</li>
          <li><strong>Nutrient cycling:</strong> Organic matter slowly releases nitrogen, phosphorus, and other essential nutrients, reducing the need for synthetic fertilizers.</li>
          <li><strong>Soil structure:</strong> SOM binds soil particles together, improving aggregation, reducing erosion, and enhancing root penetration.</li>
          <li><strong>Carbon storage:</strong> Every percentage point of SOM represents roughly 10 tonnes of carbon per hectare stored in the soil—critical for carbon credit schemes and climate mitigation.</li>
          <li><strong>Biological activity:</strong> SOM feeds soil microbes, fungi, and earthworms, which in turn improve nutrient availability and disease suppression.</li>
        </ul>
        ...
        <h2>Current Benchmarks: Where Does Your Soil Stand?</h2>
        ...
        <ul>
          <li><strong>Arable soils:</strong> 2–4% SOM (lower in intensive cereal systems, higher in rotations with grass leys)</li>
          <li><strong>Permanent pasture:</strong> 4–8% SOM (higher in wetter climates, lower in overgrazed or degraded pastures)</li>
          <li><strong>Peat soils:</strong> 20–60% SOM (but often in decline due to drainage and oxidation)</li>
        </ul>
        ...
        <h2>Practices to Build Soil Organic Matter</h2>
        ...
        <h3>2. Compost and Organic Amendments</h3>
        ...
        <h3>3. Reduced or No-Till Farming</h3>
        ...
        <h3>5. Crop Rotation and Diversity</h3>
        ...
        <h2>Timelines: How Fast Can You Build Soil Organic Matter?</h2>
        ...
        <ul>
          <li><strong>Year 1–2:</strong> Minimal measurable change in SOM, but improvements in soil structure, water infiltration, and biological activity become evident.</li>
          <li><strong>Year 3–5:</strong> SOM increases of 0.1–0.3% per year, depending on practices. Farmers report reduced fertilizer needs and improved drought resilience.</li>
          <li><strong>Year 5–10:</strong> Cumulative SOM gains of 0.5–1.5%, with significant economic returns from reduced inputs, higher yields, and eligibility for carbon credit schemes.</li>
        </ul>
      ...
      <article className="prose prose-gray max-w-none">
        <h2>Economic Returns: The Payoff of Building Soil Organic Matter</h2>
        ...
        <h3>1. Reduced Fertilizer Costs</h3>
        ...
        <h3>2. Improved Water Holding Capacity</h3>
        ...
        <h3>3. Yield Stability and Resilience</h3>
        ...
        <h3>4. Carbon Credits and Payments</h3>
        ...
        <h3>5. CSRD Compliance and Market Access</h3>
        ...
        <h2>Measuring Progress: How to Track Soil Organic Matter</h2>
        ...
        <ul>
          <li><strong>Baseline testing:</strong> Test soil organic matter levels (via loss-on-ignition or dry combustion) at the start of any regenerative program. Sample at 0–15 cm and 15–30 cm depths to capture surface and subsurface changes.</li>
          <li><strong>Annual monitoring:</strong> Re-test every 1–2 years using consistent sampling protocols. Compare results to baseline and track trends over time.</li>
          <li><strong>Soil health indicators:</strong> Complement SOM testing with measures of aggregate stability, infiltration rate, and biological activity (e.g., earthworm counts, soil respiration).</li>
          <li><strong>Record-keeping:</strong> Document management practices (cover crop species, compost applications, tillage events) to correlate interventions with SOM gains. This data is essential for carbon credit verification and CSRD reporting.</li>
        </ul>
        ...
        <h2>Connecting to Carbon Markets and CSRD Reporting</h2>
        ...
        <ul>
          <li><strong>Verified carbon accounting:</strong> Use third-party standards (e.g., Verra, Gold Standard, or Woodland Carbon Code) to quantify and certify carbon sequestration.</li>
          <li><strong>Traceability:</strong> Link SOM data to specific fields and crop lots, enabling buyers to attribute emissions reductions to sourced products.</li>
          <li><strong>Continuous improvement:</strong> Show year-on-year progress in SOM levels, not just a one-time baseline. CSRD reporting favors suppliers with measurable trajectories.</li>
        </ul>
        ...
        <h2>Overcoming Barriers: Challenges and Solutions</h2>
        ...
        <ul>
          <li><strong>Upfront costs:</strong> Cover crop seed, compost, and no-till equipment require capital investment. Solution: Access grants (e.g., Farming Innovation Fund) or carbon finance to offset costs.</li>
          <li><strong>Knowledge gaps:</strong> Many farmers lack experience with regenerative practices. Solution: Join farm clusters, attend workshops, or hire a regenerative agriculture advisor.</li>
          <li><strong>Short-term yield dips:</strong> Transitioning to no-till or diverse rotations can temporarily reduce yields. Solution: Phase in practices gradually and focus on long-term resilience rather than annual maximums.</li>
          <li><strong>Measurement complexity:</strong> Soil testing and carbon accounting can be intimidating. Solution: Use digital tools (e.g., CarbonCloud, Cool Farm Tool) to streamline data collection and reporting.</li>
        </ul>
        ...
        <h2>Conclusion: The Long Game of Soil Health</h2>
      ...
      <div className="mt-12 p-8 bg-[#B8ADE3] rounded-lg text-white">
        <h2 className="text-2xl font-bold mb-4">Ready to Regenerate Your Farm?</h2>
        <p className="mb-6">
          Explore Stack 5: Regeneration to learn how soil health, biodiversity, and carbon sequestration can transform your farm into a climate-positive business.
        </p>
        <Link
          href="/framework/stack-5-regeneration"
          className="inline-block px-6 py-3 bg-white text-[#B8ADE3] font-semibold rounded-lg hover:bg-gray-100 transition-colors"
        >
      ...
      <div className="mt-12 pt-8 border-t border-gray-200">
        ...
        <div className="space-y-3">
          ...
          >
            The Business Case for Soil Health: ROI Beyond Yield &rarr;
          </Link>
          <Link
            href="/articles/cover-crops-roi"
            className="block text-[#B8ADE3] hover:underline"
          >
            Cover Crops ROI: Calculating the Return on Soil Investment &rarr;
          </Link>
        </div>
      </div>
    </div>
