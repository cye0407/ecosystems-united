    ...
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <header className="mb-12">
        ...
        <p className="text-xl text-gray-600">
          Your buyer is reporting under CSRD. They need your data. The VSME standard tells you exactly what to provide&mdash;without the complexity of full ESRS. Here&apos;s how it works and what it means for your operation.
        </p>
      </header>
      ...
      <article className="prose prose-gray max-w-none">
        <p>
          The Voluntary Standard for SMEs&mdash;VSME&mdash;is EFRAG&apos;s answer to a simple problem: CSRD requires large companies to collect sustainability data from their supply chains, but the full European Sustainability Reporting Standards (ESRS) are disproportionate for small operations. A 15-person farm does not need the same reporting framework as Nestl&eacute;.
        </p>
        <p>
          VSME strips ESRS down to the datapoints that actually matter for SMEs in the value chain. It is the standard your buyers will increasingly reference when they send data requests. Understanding it now means you respond efficiently later&mdash;instead of scrambling with every new questionnaire.
        </p>

        <h2>Why VSME Exists</h2>
        <p>
          CSRD obligates approximately 50,000 European companies to report sustainability data across their entire value chain. When Carrefour, Lidl, or Danone report their Scope 3 emissions, they need numbers from every supplier&mdash;including farms.
        </p>
        <p>
        ...
        <ul>
          <li><strong>Energy consumption</strong>&mdash;total energy in MWh, broken down by source (electricity, diesel, gas, renewables)</li>
          <li><strong>Greenhouse gas emissions</strong>&mdash;Scope 1 and Scope 2, in tonnes CO2e. For farms, this includes livestock methane, fertiliser N2O, and fuel combustion</li>
          <li><strong>Workforce basics</strong>&mdash;headcount, gender split, health and safety incidents, training hours</li>
          <li><strong>Water</strong>&mdash;total withdrawal by source (mains, borehole, surface water, rainwater)</li>
          <li><strong>Waste</strong>&mdash;total waste by type and destination (recycling, landfill, composting)</li>
          <li><strong>Biodiversity</strong>&mdash;sites near sensitive areas, land use types, habitat features</li>
        </ul>
        <p>
        ...
        <ul>
          <li><strong>Policies</strong>&mdash;what written policies guide your environmental, social, and governance practices</li>
          <li><strong>Actions</strong>&mdash;what specific measures you have taken (e.g., reduced diesel use by switching to GPS guidance, installed rainwater harvesting, implemented seasonal worker accommodation standards)</li>
          <li><strong>Targets</strong>&mdash;where you are heading (e.g., 10% energy reduction by 2027, maintain soil organic matter above 4%)</li>
        </ul>
        <p>
          This is where many farm operations stall&mdash;not because they lack practices, but because those practices are not documented. A farm that has rotated crops for twenty years but never written it down as a soil health policy has a documentation gap, not a practice gap.
        </p>
        ...
        <ul>
          <li>Diesel consumption (litres and cost&mdash;the biggest line item for most arable operations)</li>
          <li>Electricity consumption (kWh by source, including any on-site generation)</li>
          <li>Heating fuel (gas, oil, biomass)</li>
          <li>Livestock emissions (enteric methane, manure management&mdash;calculated from headcount using IPCC factors)</li>
          <li>Fertiliser emissions (N2O from nitrogen applications&mdash;calculated from kg N applied)</li>
        </ul>
        <p>
        ...
        <ul>
          <li>Fertiliser (kg of N, P, K applied, product types, organic vs. synthetic)</li>
      ...
      <article className="prose prose-gray max-w-none">
        ...
        <ul>
          <li><strong><Link href="/articles/globalg-a-p-certification-what-sme-farms-need">GlobalG.A.P. IFA</Link></strong>&mdash;covers food safety, traceability, environmental management, and worker welfare. The IFA checklist and VSME share approximately 60-70% of the same underlying data</li>
          <li><strong><Link href="/articles/globalg-a-p-grasp-worker-welfare">GlobalG.A.P. GRASP</Link></strong>&mdash;the social practice add-on maps directly to VSME workforce metrics</li>
          <li><strong><Link href="/articles/ecolabel-guide">EU Organic</Link></strong>&mdash;organic certification records cover input restrictions, land management, and biodiversity requirements that feed VSME</li>
          <li><strong>Agri-environment schemes</strong>&mdash;AECM, stewardship, and similar programmes require habitat data, soil management records, and environmental metrics that align with VSME biodiversity requirements</li>
          <li><strong><Link href="/articles/csrd-esg-guide">Full ESRS</Link></strong>&mdash;VSME is a simplified subset. If you prepare for VSME, scaling to full ESRS later is incremental, not a restart</li>
        </ul>
        <p>
          This is the core principle: <strong>the underlying data is the same regardless of which standard asks for it</strong>. Energy is energy. Emissions are emissions. Workforce metrics are workforce metrics. What changes between standards is scope, granularity, and format&mdash;not the raw operational data.
        </p>
        <p>
        ...
        <ol>
          <li><strong>Collect your energy and fuel data</strong>&mdash;utility bills, fuel invoices, meter readings. This covers the most-requested datapoint and gives you emissions calculations immediately</li>
          <li><strong>Document your land use</strong>&mdash;field areas, use types, habitat features. You likely have this from farm maps, Basic Payment Scheme applications, or environmental stewardship records</li>
          <li><strong>Compile workforce basics</strong>&mdash;headcount, FTE, safety records, training logs. HR records and farm assurance documentation cover most of this</li>
          <li><strong>Gather input records</strong>&mdash;fertiliser applications, crop protection records, feed purchases. Spray logs and agronomist records are your source</li>
          <li><strong>Calculate emissions</strong>&mdash;apply IPCC Tier 1 emission factors to your energy, fuel, livestock, and fertiliser data. Standard methodology, not bespoke science</li>
          <li><strong>Write your policies</strong>&mdash;document what you already do. Environmental management, worker safety, chemical handling. Even a two-page policy is infinitely better than nothing</li>
          <li><strong>Set realistic targets</strong>&mdash;10% diesel reduction, maintain soil organic matter, zero lost-time incidents. Targets should be achievable and measurable</li>
        </ol>
        <p>
          Steps 1-5 give you the <Link href="/articles/vsme-basic-module-explained">Basic Module</Link>. Steps 6-7 move you into <Link href="/articles/vsme-basic-module-explained">Narrative-PAT territory</Link>. The entire process builds on data you largely already possess&mdash;it just needs to be structured.
        </p>
        ...
        <ul>
          <li><strong>Now&ndash;2026</strong>&mdash;large food retailers and processors are sending initial data requests. These may not reference VSME by name, but the datapoints requested will increasingly align with it</li>
          <li><strong>2026&ndash;2027</strong>&mdash;VSME becomes the standard reference framework for supply chain data collection. Buyers shift from ad-hoc questionnaires to structured VSME-aligned templates</li>
          <li><strong>2028+</strong>&mdash;listed SMEs begin their own CSRD reporting. Agricultural cooperatives and larger farm groups may report directly</li>
        </ul>
        <p>
      ...
      <div className="mt-12 p-8 bg-[#3D2E7C] rounded-lg text-white">
        ...
        <p className="text-white/80 mb-6">
          The Five Stacks Tracker structures your operational data across the same domains VSME asks for&mdash;energy, materials, workforce, emissions, land use. Collect once, respond to anything.
        </p>
