  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <article className="prose prose-gray max-w-none">
        ...
        <h2>The measurement foundation everything else builds on</h2>
        <p>
          This checklist is your measurement foundation in practical form. It
          defines what you need to measure, where the data comes
        ...
        <p>
          ...
          That baseline is the foundation for everything else: answering buyer
          requests without a scramble, finding efficiency gains, building
          operational resilience, and proving long-term regenerative value.
        </p>
        <p>
