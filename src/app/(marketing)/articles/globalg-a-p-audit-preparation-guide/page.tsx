  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="mt-12 p-8 bg-[#5B4A9E] rounded-lg text-white">
        <h3 className="text-2xl font-bold mb-3">Automate Your Audit Preparation</h3>
        <p className="text-white/80 mb-4">
          Track your operational data year-round. When audit time comes, upload
          your GlobalG.A.P. checklist and get draft responses generated from
          your actual farm data, not guesswork.
        </p>
        <Link
          href="/signup"
