  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <article className="prose prose-gray max-w-none">
        ...
        <h2>Answer these before you spend the money</h2>
        <p>
          These questions apply one discipline to a major capital decision: measure before you invest. Before committing to irrigation infrastructure, you need data about your current situation—soil, climate, water, crops.
        </p>
        <p>
          The questions to keep asking: what do we know, and what do we need to know? Irrigation decisions made without this foundation often result in systems that are wrong-sized, inefficient, or unsuited to actual conditions.
        </p>
        <p>
