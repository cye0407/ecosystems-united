  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <article className="prose prose-gray max-w-none">
        ...
        <p>
          Understanding your land&apos;s classification reveals its natural strengths and constraints. Grade 1 and 2 land can support virtually any crop and justifies intensive management and high input costs. Grade 3 land (subdivided into 3a and 3b) comprises the majority of UK agricultural land and is suitable for most crops with appropriate management. Grade 4 land has severe limitations &mdash; perhaps poor drainage, shallow soils, or steep slopes &mdash; and is generally best suited to grassland. Grade 5 land is extremely limited and often better managed for environmental outcomes than production.
        </p>
        ...
        <h2>Matching Enterprises to Soil and Topography</h2>

        <p>
          Once you understand land capability, the next step is matching enterprises to specific fields. This isn&apos;t just about what can grow &mdash; it&apos;s about what will be most profitable given the land&apos;s characteristics and the resources required to succeed.
        </p>
        ...
        <p>
          The strategic question isn&apos;t &ldquo;What have we always done here?&rdquo; but rather &ldquo;What enterprise will generate the highest margin with the lowest risk on this specific parcel?&rdquo; This often reveals opportunities to shift land use in ways that immediately improve profitability.
        </p>

        <h2>Field-by-Field Profitability Analysis</h2>
        ...
        <p>
          Start by mapping actual yields over several seasons. Combine this with input costs &mdash; seed, fertilizer, pesticides, fuel, labor &mdash; allocated to each field. The results often reveal stark differences. One field might consistently deliver 10 tonnes per hectare of wheat at a gross margin of £800 per hectare, while another struggles to reach 7 tonnes and barely breaks £300 per hectare after accounting for the extra inputs needed to compensate for poor soil or difficult access.
        </p>

        <p>
          This analysis exposes fields that are subsidizing the farm average. Perhaps a poorly drained field requires extra cultivations, delayed drilling, and higher disease pressure. The yield is mediocre, but the enterprise continues because &ldquo;it&apos;s always been wheat.&rdquo; Strategic planning asks: what would happen if we converted that field to permanent pasture, rented it for grazing, or entered it into an environmental scheme?
        </p>
        ...
        <h2>Integrating Environmental Features into Productive Systems</h2>
        ...
        <p>
          The key is integration. Rather than scattering environmental features randomly, strategic planning places them where they deliver multiple benefits &mdash; protecting vulnerable soils, managing water, enhancing biodiversity, and generating income through agri-environment schemes.
        </p>

        <h2>Environmental Land Management and Agri-Environment Schemes</h2>

        <p>
          The shift from area-based subsidies to Environmental Land Management (ELM) schemes in England, and equivalent programs across Europe, fundamentally changes the economics of land use. Under the old system, every hectare in production generated a Basic Payment. Under ELM, payment flows to environmental outcomes &mdash; and some land generates more value through ecosystem services than through production.
        </p>

        <p>
          ELM&apos;s three tiers &mdash; Sustainable Farming Incentive (SFI), Countryside Stewardship (CS), and Landscape Recovery &mdash; offer progressively higher payments for increasingly ambitious environmental management. Strategic land use planning identifies which fields are best suited to which tier.
        </p>
      ...
      <article className="prose prose-gray max-w-none">
        ...
        <h2>Biodiversity Net Gain and Strategic Retirement</h2>
        ...
        <p>
          Strategic land use planning identifies parcels suitable for BNG. Typically these are lower-grade fields with existing environmental features &mdash; perhaps rough grassland, scrub, or wetland edges. Rather than continuing low-return production, these areas can be enhanced for biodiversity, measured using the statutory biodiversity metric, and registered as BNG units. The income is often multiples of the agricultural return, locked in for 30 years or more.
        </p>

        <p>
          This isn&apos;t about taking productive land out of farming &mdash; it&apos;s about strategic retirement of unproductive land. A 5-hectare parcel that generates £200 per hectare in marginal grazing (£1,000 total) but requires significant fencing, water, and management might instead generate £5,000-£10,000 annually as a BNG site, with minimal ongoing cost. The capital released &mdash; saved fencing, reduced machinery, freed management time &mdash; can be reinvested in more productive areas.
        </p>

        <h2>Using GIS and Mapping Tools</h2>
        ...
        <p>
          Start by creating a base map of your farm with field boundaries. Overlay soil type data (available from national soil databases), topographic contours, and any existing yield maps. Add environmental features &mdash; hedgerows, ponds, watercourses, woodland. Color-code fields by enterprise and calculated profitability.
        </p>
        ...
        <p>
          The map becomes a strategic planning tool. Scenario modeling &mdash; what if we converted Field 12 to grassland? What if we entered the western block into Landscape Recovery? &mdash; becomes visual and collaborative. The entire farm team can engage with the plan, and decisions are grounded in spatial reality rather than abstract spreadsheets.
        </p>

        <h2>Connecting Land Use to CSRD Biodiversity Reporting</h2>
        ...
        <p>
          Farms that can demonstrate strategic land management &mdash; field-level profitability analysis, integration of environmental features, participation in agri-environment schemes, measurable biodiversity improvements &mdash; become preferred suppliers. The data generated through GIS mapping and environmental monitoring flows directly into customer sustainability reports, providing the evidence trail that CSRD compliance demands.
        </p>

        <p>
          Document your land use decisions: why specific fields were entered into environmental schemes, how you&apos;re managing marginal land for biodiversity, what measurable outcomes you&apos;re achieving. This narrative, backed by spatial data and monitoring results, demonstrates that your farm isn&apos;t just producing commodities &mdash; it&apos;s managing landscapes for multiple outcomes. That story strengthens customer relationships, supports premium pricing, and future-proofs your business as sustainability requirements tighten.
        </p>

        <h2>The Business Case for Strategic Land Use</h2>

        <p>
          Strategic land use planning isn&apos;t an environmental luxury &mdash; it&apos;s a business necessity. Farms that continue to manage land according to historical precedent leave money on the table, over-invest in marginal areas, and miss opportunities in environmental markets.
        </p>
      ...
      <div className="mt-12 pt-8 border-t border-gray-200">
        ...
        <div className="space-y-3">
          <Link
            href="/articles/erosion-control-strategies"
            className="block text-[#5B4A9E] hover:underline"
          >
            Practical Erosion Control Strategies for Working Farms &rarr;
          </Link>
          <Link
            href="/articles/soil-testing-guide"
            className="block text-[#5B4A9E] hover:underline"
          >
            A Practical Guide to Soil Testing and Interpretation &rarr;
          </Link>
        </div>
      </div>
    </div>
