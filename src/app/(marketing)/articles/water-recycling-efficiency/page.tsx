  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <article className="prose prose-gray max-w-none">
        ...
        <p>
          The most useful metric is water use per unit of production: litres per kilogram of crop, litres per litre of milk, litres per kilogram of liveweight gain. This efficiency metric accounts for production scale and makes year-on-year comparison meaningful. It also feeds directly into your core sustainability metrics and ESG reporting&mdash;when a buyer asks about your water footprint, this is the number they want.
        </p>
        <p>
