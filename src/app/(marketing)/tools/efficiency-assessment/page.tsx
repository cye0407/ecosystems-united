    ...
    return (
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="bg-[#1a1a2e] rounded-lg p-6 mb-8 text-white">
          <h2 className="font-semibold mb-2">Take the Efficiency Scorecard with you</h2>
          ...
          <GatedDownload
            feature="efficiency-scorecard"
            fileUrl="/downloads/farm-efficiency-scorecard.xlsx"
            fileName="Farm-Efficiency-Scorecard.xlsx"
