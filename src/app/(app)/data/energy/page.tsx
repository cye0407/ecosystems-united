    ...
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        {categories.map((cat) => {
          const Icon = cat.icon;
          return (
            <Link key={cat.id} href={`/data/energy/entry?tab=${cat.id}`}>
      ...
      <Card className="bg-primary-100 rounded-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <Link href="/data/energy/entry?tab=electricity">
          ...
          <Link href="/data/energy/entry?tab=fuels">
            <div className="flex items-center gap-3 p-3 bg-white rounded-xl border border-gray-200 hover:border-primary hover:shadow-sm transition-all">
          ...
          <Link href="/data/energy/entry?tab=water">
            <div className="flex items-center gap-3 p-3 bg-white rounded-xl border border-gray-200 hover:border-primary hover:shadow-sm transition-all">
