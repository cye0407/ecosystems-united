    ...
    <>
      ...
      <div className="px-5 py-5 border-b border-gray-200">
        <Link href="/dashboard" className="flex items-center gap-3" onClick={onLinkClick}>
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-primary to-stack-3 flex items-center justify-center shrink-0">
            <span className="text-white font-bold text-sm">EU</span>
          </div>
          <span className="font-semibold text-gray-900">Metrics</span>
        </Link>
      </div>
